...
const errorType = ["valueMissing", "typeMismatch", "patternMismatch", "tooLong", "tooShort", "customError" ];
...
const mensajesError = {
    ...
    password: {
        ...
        patternMismatch: "Tiene que tener al menos 6 caracteres, máximo 12, debe tener al menos una letra minúscula, una mayúscula, un número y no puede contener caracteres especiales."
    },
    phone: {
        valueMissing: "Este campo no puede estar vacio.",
    ...
    //     patternMismatch: "Tu dirección debe tener de 10 a 40 caracteres",
        
    // },
    // city: {
    //     valueMissing: "La ciudad no puede estar vacia.",
    //     patternMismatch: "Tu ciudad debe tener de 4 a 20 caracteres",
